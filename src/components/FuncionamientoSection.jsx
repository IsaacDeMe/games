...
const FuncionamientoSection = () => {
  const steps = [
    ...
    },
    {
      number: 3,
      title: "Pago",
      description: "Una vez pagado, por bizum (te diremos que debes de poner en concepto...) tu reserva pasará de \"provisional\" a \"pagada\" en tu perfil."
    },
    {
      number: 4,
      title: "Entrega",
      description: "Recoge en El Vendrell (43700) o envío hablamos para hacer el envío a traves de Wallapop"
    }
  ];
